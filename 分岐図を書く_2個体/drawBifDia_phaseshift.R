...
plot(unstable$V1, unstable$V2, pch = 15, col = "gray", 
     xlim = span.r, ylim = span.phi, yaxt = "n", xlab = "", ylab = "")
par(new=T)
plot(unstable$V1, unstable$V3, pch = 15, col = "gray", 
     xlim = span.r, ylim = span.phi, yaxt = "n", xlab = "", ylab = "")
par(new=T)
plot(stable$V1, stable$V2, pch = 15, col = "black", 
     xlim = span.r, ylim = span.phi, yaxt = "n", xlab = "Distance between two interacting frogs [m]", ylab = "Phi Equilibrium Solution")
par(new=T)
plot(stable$V1, stable$V3, pch = 15, col = "black", 
     xlim = span.r, ylim = span.phi, yaxt = "n", xlab = "", ylab = "")
